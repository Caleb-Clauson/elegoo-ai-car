...
# =============================================
MODEL_PATH = "/Users/calebclauson/Desktop/converted_keras(car)/keras_model.h5"
LABELS_PATH = "/Users/calebclauson/Desktop/converted_keras(car)/labels.txt"
    ...
    while reconnect_attempts < MAX_RECONNECT_ATTEMPTS:
        try:
            ...
            if "people" in class_name:
                ...
                #safe_send(s, b'{"N":3,"D1":3,"D2":100}') # orignal
                safe_send(s, b'{"N":4,"D1":89,"D2":100}') # Can use this or the orginal
                time.sleep(2.5) 
                safe_send(s, b'{"N":100}')
